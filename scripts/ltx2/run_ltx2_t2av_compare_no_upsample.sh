...
--config_json ${lightx2v_path}/configs/ltx2/ltx2_compare_no_upsample.json \
...
--save_result_path ${lightx2v_path}/save_results/output_lightx2v_ltx2_t2av_compare_no_upsample.mp4
