...
output_path="${output_path:-${lightx2v_path}/save_results/wan_t2v_ltx2_bridge_step40_seed${seed}.mp4}"
base_config="${lightx2v_path}/configs/changing_resolution/wan_t2v_ltx2_bridge_step40.json"
runtime_config="${lightx2v_path}/save_results/runtime_wan_t2v_ltx2_bridge_step40_seed${seed}.json"
